...
class itemHelper
{
 ...
 {
 	if($iteam_id != 0 || $iteam_id != '0')
 	return str_replace('_', ' ', $this->item_list[$iteam_id]) ;
 }
  public  function renderItem_image($iteam_id)
 {
 	if($iteam_id != 0 || $iteam_id != '0')
 	return "http://media.steampowered.com/apps/dota2/images/items/".$this->item_list[$iteam_id]."_lg.png" ;
 }
  public  function isItem($iteam_id)
 {
 	if($iteam_id != 0 || $iteam_id != '0')
 		return true ;
	else false ;
